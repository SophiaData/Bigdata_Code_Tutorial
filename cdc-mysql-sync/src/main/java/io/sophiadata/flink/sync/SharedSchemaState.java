...
/**
 * Static shared state between Flink operators. Flink serializes each operator's closure
...
final class SharedSchemaState {
    ...
    private static final Map<String, String> PKS = new ConcurrentHashMap<>();

    private SharedSchemaState() {}

    static Map<String, Map<String, String>> schemas() {
        return SCHEMAS;
    }

    static Map<String, String> pks() {
        return PKS;
    }
}
